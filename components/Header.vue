<template>
  <header class="absolute top-0 left-0 w-full z-50">
    <div class="flex justify-between items-center p-6 max-w-7xl mx-auto">
      ...
      <!-- Install Button -->
      <button class="hidden lg:block bg-white py-2 px-4 rounded-lg transform transition-all duration-300 ease-in-out hover:scale-110">
        Install Now
      </button>
    </div>
    ...
    >
     ...
     <div class="h-[60vh] bg-white w-full flex flex-col p-5">
      <div class="flex justify-between items-center mb-4">
        ...
        <button @click="toggleDropdown" class="hover:cursor-pointer focus:outline-none">
      ...
      <ul
        class="flex flex-col space-y-4 justify-center items-center font-[500] text-secondary_txt_color text-2xl"
      >
        <li class="py-3">
          <a
            href="#how-it-works"
        ...
        <li class="py-3">
          <a href="#benefits" class="hover:text-primary" @click="toggleDropdown"
            >Benefits</a
          >
        </li>
        <li class="py-3">
